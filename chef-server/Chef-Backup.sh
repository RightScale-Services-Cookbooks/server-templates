...
#   CHEF_BACKUP_BUCKET:
#     Category: Backup
#     Description: GCE bucket to save backups to.
#     Input Type: single
#     Required: true
#     Advanced: false
# Attachments: []
...
GS_LOCATION="gs://${CHEF_BACKUP_BUCKET}/${SHORT_BACKUP}"
...
gsutil cp ${FULL_BACKUP} ${GS_LOCATION}
rm ${FULL_BACKUP}

echo "Backup complete!"
echo "Backup located at: ${GS_LOCATION}"
